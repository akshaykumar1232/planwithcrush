const data = [
  ...
  id: 8,
  name: "Mysore",
  info: "Mysore, located in Karnataka, is famous for its royal heritage and magnificent monuments. The grand Mysore Palace, lit up beautifully especially during Dasara, and bustling local markets make it a cultural highlight.",
  image: "https://images.unsplash.com/photo-1662100593533-5a8470ebcd0e?auto=format&fit=crop&w=800&q=60",
  price: "52,300",
	},
	{
  id: 9,
  name: "Varanasi",
  info: "Varanasi, on the banks of the holy Ganges in Uttar Pradesh, is one of the world’s oldest continuously inhabited cities. Known for its sacred ghats, evening Aarti rituals, and deeply spiritual atmosphere.",
  image: "https://images.unsplash.com/photo-1579583760640-9f4af9064e8c?auto=format&fit=crop&w=800&q=60",
  price: "47,850",
	}
